...
Документация — в [docs/](docs/), описание продукта инбокса — в
[docs/inbox.md](docs/inbox.md). Оперативные задачи живут не здесь: с 2026-08-09
все шесть проектов Sepia ведутся одним трекером `TODO.md` в корне рабочей папки
(этажом выше этого репозитория, вне гита проекта).
